...
Directory Sandbox
The Open Banking Directory Sandbox provides a test instance of the real directory so that providers can test their implementations before going live. You’ll need to registered with the Open Banking Directory Sandbox in order to use the Currencycloud API sandbox.
...
### OBL
Open Banking Limited (formerly Open Banking Implementation Entity) has been tasked with overseeing the delivery of Open Banking in the UK.
